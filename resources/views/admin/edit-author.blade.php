...
<section id="inner-page">   
            <div class="container" style="padding: 0 200px;">
                <div class="card">
                    <h3 class="text-center card-header">Edit Data Author</h3>
                    <form action="{{ route('data-author.update', $model->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="card-text grid-item p-4">
                        <div class="mb-3">
                                <label form="title" class="form-label">Author Full Name</label>
                                <input type="text" name="author_name" class="form-control" id="author_name" aria-describedby="title" value="{{ $model->author_name }}">
                            </div>
