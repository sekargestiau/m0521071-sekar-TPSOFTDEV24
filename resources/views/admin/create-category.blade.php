...
@section('title','Data Kategori - Sistem Informasi Perpustakaan')
...
<section id="inner-page">   
            <div class="container" style="padding: 0 200px;">
                <div class="card">
                    <h3 class="text-center card-header">Crete Author</h3>
                    <form action="{{ route('category.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card-text grid-item p-4">
                        <div class="mb-3">
                                <label form="name" class="form-label">Category</label>
                                <input type="text" name="category" class="form-control" id="category" aria-describedby="name" required>
                            </div>
