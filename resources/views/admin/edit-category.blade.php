...
@section('title','Data Category - Sistem Informasi Perpustakaan')
...
<section id="inner-page">   
            <div class="container" style="padding: 0 200px;">
                <div class="card">
                    <h3 class="text-center card-header">Edit Data Category</h3>
                    <form action="{{ route('data-category.update', $model->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="card-text grid-item p-4">
                        <div class="mb-3">
                                <label form="title" class="form-label">Category</label>
